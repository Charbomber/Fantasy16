...
function mw6812( mw6812Clock , mw6812Reg )
	...
	for mw6812Channel=1,5 do
		...
		if (mw6812Reg[mw6812Channel][6] or mw6812Reg[mw6812Channel][6] == 1) then mw6812OutL = mw6812OutL + mw6812ChannelOut / 5 end
		if (mw6812Reg[mw6812Channel][7] or mw6812Reg[mw6812Channel][7] == 1) then mw6812OutR = mw6812OutR + mw6812ChannelOut / 5 end
	end
	
	return { mw6812OutL , mw6812OutR }
end